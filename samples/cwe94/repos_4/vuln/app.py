...
def run(name):
  ...
  "tax_rate": 0.07
    ...
    try:
        # Vulnerable sink: directly compiles and executes user-provided code
        result = run_formula(formula['body'], payload)
