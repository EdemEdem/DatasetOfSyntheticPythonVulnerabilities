...
import tornado.web
import os
from tornado.escape import xhtml_escape  # <-- safe escaping
...
class SubmitHandler(tornado.web.RequestHandler):
    def post(self):
        ...
        safe = xhtml_escape(raw)
        FEEDBACK_STORE.append(safe)
...
if __name__ == "__main__":
    app = make_app()
    app.listen(8888)
    print("Safe Tornado app running on http://localhost:8888")
